...
CREATE TABLE `address`  (
  ...
  `default_value` tinyint(1) NULL DEFAULT 0 COMMENT '是否为所属会员的默认收货地址',
...
INSERT INTO `address` VALUES (8, '935840473@qq.com', '18854702801', '东海', '-9999', 5, 1);
INSERT INTO `address` VALUES (9, 'Bert', '18916132455', '沪城环路1851上海电力大学', '200030', 4, 1);
...
CREATE TABLE `category`  (
  ...
  `alias` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类目别名',
  `p_id` int(11) NULL DEFAULT NULL COMMENT '父类目编号',
  `order_weight` int(11) NULL DEFAULT NULL COMMENT '排序权重',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `category` VALUES (4, ' 家 电', 'jiadian', NULL, 10);
...
INSERT INTO `category` VALUES (17, '冰箱', 'bingxiang', 4, 10);
INSERT INTO `category` VALUES (18, '空调', 'kongtiao', 4, 10);
INSERT INTO `category` VALUES (19, '洗衣机', 'xiyiji', 4, 10);
INSERT INTO `category` VALUES (20, '摄影摄像', 'sheyingshexiang', 6, 10);
INSERT INTO `category` VALUES (21, '摄影配件', 'sheyingpeijian', 6, 10);
INSERT INTO `category` VALUES (22, '潮品', 'chaopin', 6, 10);
INSERT INTO `category` VALUES (23, '奢侈品', 'shechiping', NULL, 10);
INSERT INTO `category` VALUES (24, '豪车', 'haoche', 23, 10);
INSERT INTO `category` VALUES (25, '通信娱乐', 'tongxinyule', NULL, 10);
INSERT INTO `category` VALUES (26, '手机卡', 'shoujika', 25, 10);
INSERT INTO `category` VALUES (27, '点券', 'dianjuan', 25, 10);
INSERT INTO `category` VALUES (28, '宝石', 'baoshi', 23, 10);
INSERT INTO `category` VALUES (29, '名表', 'mingbiao', 23, 10);
...
CREATE TABLE `item`  (
  ...
  `total_price` decimal(9, 2) NULL DEFAULT NULL COMMENT '单品总价',
  `payment_price` decimal(9, 2) NULL DEFAULT NULL COMMENT '单品实付的总价',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `item` VALUES (10, 8, 21, 4, 3196.00, 2396.00);
INSERT INTO `item` VALUES (11, 9, 15, 7, 6993.00, 6993.00);
INSERT INTO `item` VALUES (12, 10, 9, 0, 0.00, 0.00);
INSERT INTO `item` VALUES (13, 10, 26, -3, -26997.00, -26100.00);
INSERT INTO `item` VALUES (14, 11, 24, 3, 5997.00, 4500.00);
INSERT INTO `item` VALUES (15, 12, 17, 6, 11988.00, 9000.00);
INSERT INTO `item` VALUES (16, 13, 21, 1, 799.00, 599.00);
INSERT INTO `item` VALUES (17, 14, 16, 4, 10800.00, 8000.00);
INSERT INTO `item` VALUES (18, 15, 24, 4, 7996.00, 6000.00);
INSERT INTO `item` VALUES (19, 16, 23, 3, 7800.00, 6900.00);
INSERT INTO `item` VALUES (20, 16, 24, 4, 7996.00, 6000.00);
INSERT INTO `item` VALUES (21, 16, 25, 3, 20997.00, 20550.00);
INSERT INTO `item` VALUES (22, 16, 26, 3, 26997.00, 26100.00);
INSERT INTO `item` VALUES (23, 17, 17, 4, 7992.00, 6000.00);
INSERT INTO `item` VALUES (24, 17, 18, 2, 300.00, 260.00);
INSERT INTO `item` VALUES (25, 18, 2, 4, 21152.00, 19520.00);
INSERT INTO `item` VALUES (26, 18, 21, 2, 1598.00, 1198.00);
INSERT INTO `item` VALUES (27, 19, 17, 3, 5994.00, 4500.00);
INSERT INTO `item` VALUES (28, 19, 13, 1, 3288.00, 3288.00);
INSERT INTO `item` VALUES (29, 20, 16, 1, 2700.00, 2000.00);
INSERT INTO `item` VALUES (30, 21, 23, 1, 2600.00, 2300.00);
INSERT INTO `item` VALUES (31, 22, 26, 3, 26997.00, 26100.00);
INSERT INTO `item` VALUES (32, 22, 11, 2, 7398.00, 6398.00);
INSERT INTO `item` VALUES (33, 23, 9, 10, 129990.00, 129990.00);
INSERT INTO `item` VALUES (34, 24, 17, 3, 5994.00, 4500.00);
INSERT INTO `item` VALUES (35, 25, 2, 2, 10576.00, 9760.00);
INSERT INTO `item` VALUES (36, 25, 9, 10, 129990.00, 129990.00);
INSERT INTO `item` VALUES (37, 26, 26, 6, 53994.00, 52200.00);
INSERT INTO `item` VALUES (38, 27, 17, 1, 1998.00, 1500.00);
INSERT INTO `item` VALUES (39, 29, 12, 1, 3399.00, 3099.00);
INSERT INTO `item` VALUES (40, 30, 9, 1, 12999.00, 12999.00);
INSERT INTO `item` VALUES (41, 31, 15, 4, 3996.00, 3996.00);
...
CREATE TABLE `member`  (
  ...
  `real_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实名',
  `email` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱号',
  `gender` tinyint(1) NULL DEFAULT 0 COMMENT '性别，默认值false',
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES (4, '18916132455', '18916132455', '杨过', '杨过', '123123', 1, '2019-12-12 19:54:12');
INSERT INTO `member` VALUES (5, '18854702801', 'LIUjiJIN', '匿名', NULL, NULL, 0, '2019-12-12 22:43:30');
...
CREATE TABLE `news`  (
  ...
  `top` tinyint(1) NULL DEFAULT 0 COMMENT '是否轮播图，默认值false',
  `hits` int(11) NULL DEFAULT 0 COMMENT '阅读次数',
...
CREATE TABLE `orders`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `number` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `buyer_id` int(11) NOT NULL COMMENT '所属买家会员编号',
  `total_amount` int(11) NULL DEFAULT NULL COMMENT '商品总数量',
  `total_price` decimal(9, 2) NULL DEFAULT NULL COMMENT '总的费用',
  `payment_price` decimal(9, 2) NULL DEFAULT NULL COMMENT '实付的费用',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '买家留言',
  `contact` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收货人',
...
INSERT INTO `orders` VALUES (8, '20191212200434589', 4, 4, 3196.00, 2396.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-12 20:04:27', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (9, '20191212204302098', 4, 7, 6993.00, 6993.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-12 20:42:53', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (10, '20191212224503257', 5, -3, -26997.00, -26100.00, '啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊', '935840473@qq.com', '18854702801', '东海', '-9999', '2019-12-12 22:44:54', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (11, '20191213094626418', 4, 3, 5997.00, 4500.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 09:46:24', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (12, '207585200127120012800', 4, 6, 11988.00, 9000.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 11:49:02', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (13, '207585370320140417280', 4, 1, 799.00, 599.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 11:51:19', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (14, '207609850318234806272', 4, 4, 10800.00, 8000.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 16:57:45', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (15, '207610170829024424192', 4, 4, 7996.00, 6000.00, '3333333333', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:02:09', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (16, '207610951006093723968', 4, 13, 63790.00, 59550.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:12:35', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (17, '207612100228065811072', 4, 6, 8292.00, 6260.00, 'daf', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:26:53', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (18, '207612650423080707008', 4, 6, 22750.00, 20718.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:33:50', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (19, '207613280220094236288', 4, 4, 9282.00, 7788.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:41:43', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (20, '207613670303053423232', 4, 1, 2700.00, 2000.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:46:36', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (21, '207613940124155203840', 4, 1, 2600.00, 2300.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 17:49:59', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (22, '207615280208162518592', 4, 5, 34395.00, 32498.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 18:06:46', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (23, '207618450406015340864', 4, 10, 129990.00, 129990.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 18:46:32', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (24, '207618540202152749760', 4, 3, 5994.00, 4500.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 18:47:40', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (25, '207618780210234900544', 4, 12, 140566.00, 139750.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-13 18:50:41', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (26, '207690370415174601088', 4, 6, 53994.00, 52200.00, '', 'aa', 'dd', 'cc', 'ff', '2019-12-14 09:48:23', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (27, '207706150122203329600', 4, 1, 1998.00, 1500.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-14 13:06:13', NULL, NULL, NULL, 2);
INSERT INTO `orders` VALUES (28, '207758291028001745984', 4, 0, 0.00, 0.00, '', 'aa', 'bb', 'cc', 'dd', '2019-12-15 00:00:08', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (29, '207759070409192103744', 4, 1, 3399.00, 3099.00, '', 'Bert', '18916132455', '沪城环路1851上海电力大学', '200030', '2019-12-15 00:09:51', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (30, '207832460616182107456', 4, 1, 12999.00, 12999.00, 'dd', 'Bert', '18916132455', '沪城环路1851上海电力大学', '200030', '2019-12-15 15:30:05', NULL, NULL, NULL, 1);
INSERT INTO `orders` VALUES (31, '207944940329195342656', 4, 4, 3996.00, 3996.00, '', 'Bert', '18916132455', '沪城环路1851上海电力大学', '200030', '2019-12-16 15:00:36', NULL, NULL, NULL, 2);
...
CREATE TABLE `product`  (
  ...
  `thumbnail` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '主配图片',
  `inventory` int(11) NULL DEFAULT 0 COMMENT '库存数量',
  `sales_volume` int(11) NULL DEFAULT 0 COMMENT '售出数量',
  `price` decimal(9, 2) NULL DEFAULT 0.00 COMMENT '定价',
  ...
  `selling_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卖点富文本描述',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `sale_time` datetime(0) NULL DEFAULT NULL COMMENT '开售时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`) USING BTREE
